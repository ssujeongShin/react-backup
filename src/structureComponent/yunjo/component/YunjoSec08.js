...
function YunjoSec08() {
  return (
    <div className="yunjo_sec08">
        ...
        <figure>
            <video muted loop autoPlay id="video03" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="200" data-aos-offset="300">
            <source src="./media/yunjo_video/video_pc/yunjo_video03_pc.mp4" type="video/mp4"/>
            </video>
        </figure>
        </section>
    </div>
